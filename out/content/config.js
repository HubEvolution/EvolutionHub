    ...
    astro_content_1.z
      .object({
        ...
        leadMagnets: astro_content_1.z
          .array(
            astro_content_1.z.string().refine((id) => {
        ...
        funnel: astro_content_1.z
          .object({
            ...
            conversionGoal: astro_content_1.z
              .enum(['newsletter', 'lead', 'consultation', 'social'])
              .optional(),
          })
          .optional(),
        ...
        funnelSeo: astro_content_1.z
          .object({
            ...
            secondaryKeywords: astro_content_1.z
              .array(astro_content_1.z.string())
              .max(5)
              .default([]),
