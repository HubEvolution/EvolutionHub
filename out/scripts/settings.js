...
exports.initSettingsPage = exports.handleAvatarUpload = exports.handlePasswordForm = exports.handleProfileForm = void 0;
...
const handleAvatarUpload = () => {
    ...
    if (!(uploadElement instanceof HTMLInputElement))
        return;
    if (!(changeButton instanceof HTMLButtonElement))
        return;
    if (previewElement && !(previewElement instanceof HTMLImageElement))
        return;
