...
exports.POST = (0, api_middleware_1.withApiMiddleware)(async (context) => {
    ...
    if (!user)
        return (0, api_middleware_1.createApiError)('auth_error', 'Authentication required for saving templates');
    ...
    if (!kv)
        return (0, api_middleware_1.createApiError)('server_error', 'KV not available');
