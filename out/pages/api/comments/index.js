...
exports.GET = (0, api_middleware_1.withApiMiddleware)(async (context) => {
    try {
        ...
        const entityType = entityTypeQ === 'blog_post' || entityTypeQ === 'project' || entityTypeQ === 'general'
            ? entityTypeQ
            : undefined;
        const filters = {
            status,
        ...
        const { CommentService } = await Promise.resolve().then(() => require('@/lib/services/comment-service'));
