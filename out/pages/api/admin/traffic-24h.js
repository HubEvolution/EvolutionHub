...
exports.GET = (0, api_middleware_1.withAuthApiMiddleware)(async (context) => {
    ...
    const wantSeries = url.searchParams.get('series') === '1' || url.searchParams.get('series') === 'true';
  ...
  `;
    ...
    try {
      ...
      `;
        ...
        return (0, api_middleware_1.createApiSuccess)({ pageViews, visits, from: datetimeStart, to: datetimeEnd, series });
    }
    catch (e) {
