...
exports.POST = (0, api_middleware_1.withAuthApiMiddleware)(async (context) => {
    ...
    if (!body?.type || !body?.description) {
        return (0, api_middleware_1.createApiError)('validation_error', 'Maintenance type and description are required');
    }
    try {
        ...
        return (0, api_middleware_1.createApiSuccess)({ maintenanceId, message: 'Maintenance job started successfully' });
    }
    catch (e) {
