...
exports.HEAD = exports.OPTIONS = exports.PATCH = exports.PUT = exports.POST = exports.DELETE = exports.GET = void 0;
...
exports.DELETE = (0, api_middleware_1.withAuthApiMiddleware)(async (context) => {
    ...
    try {
        ...
        if (parsed && typeof parsed === 'object') {
            ...
            if (typeof parsed.notifyUser === 'boolean')
    ...
    try {
        ...
        const moderation = await service.moderateComment(commentId, { action: 'hide', reason }, String(user.id));
