...
exports.POST = (0, api_middleware_1.withApiMiddleware)(async (context) => {
    ...
    try {
        ...
        const out = await service.transcribeChunk(ownerType, ownerId, sessionId, file, lang, ent.dailyBurstCap);
        ...
        return (0, api_middleware_1.createApiError)(type, err.message || 'Unknown error', err.details || undefined);
    }
