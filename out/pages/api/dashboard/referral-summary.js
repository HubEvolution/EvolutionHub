...
exports.GET = (0, api_middleware_1.withAuthApiMiddleware)(
  async (context) => {
    ...
    try {
      const profile = await (0, referral_profile_service_1.getOrCreateReferralProfile)(
        db,
        user.id,
        startedAt
      );
      const summary = await (0, referral_summary_service_1.getReferralSummary)(db, user.id);
      const referralLink = (0, referral_profile_service_1.buildReferralLink)(
...
exports.POST = (0, api_middleware_1.withAuthApiMiddleware)(
  () => (0, api_middleware_1.createMethodNotAllowed)('GET'),
