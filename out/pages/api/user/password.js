...
const goneJson = (context) => (0, response_helpers_1.createDeprecatedGoneJson)(context, 'This endpoint has been deprecated. Password changes are no longer supported; use Stytch flows.', { Allow: 'POST' });
