 ...
 */
exports.PUT = (0, api_middleware_1.withAuthApiMiddleware)(async (_context) => {
    ...
    onError: (_context, _error) => {
        return (0, api_middleware_1.createApiError)('server_error', 'An error occurred during settings update');
    },
});
