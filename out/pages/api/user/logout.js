...
const handleLogout = async (context) => {
    try {
        ...
        if (rateLimitResponse) {
            ...
            (0, security_logger_1.logSecurityEvent)('RATE_LIMIT_EXCEEDED', {
                reason: 'rate_limit',
        ...
        if (sessionId) {
            ...
            (0, security_logger_1.logSecurityEvent)('API_ACCESS', {
                action: 'logout',
            ...
            (0, security_logger_1.logSecurityEvent)('AUTH_SUCCESS', {
        ...
        (0, security_logger_1.logSecurityEvent)('AUTH_FAILURE', {
            reason: 'logout_error',
            sessionId: sessionId,
            path: '/api/user/logout',
            error: error,
