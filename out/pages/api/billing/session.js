...
exports.POST = (0, api_middleware_1.withAuthApiMiddleware)(async (context) => {
    ...
    if (!body || !body.plan || !body.workspaceId) {
        return (0, api_middleware_1.createApiError)('validation_error', 'plan and workspaceId are required');
    }
    let refererPath = '';
    try {
    ...
    const safeReturnTo = (0, sanitizeReturnTo_1.sanitizeReturnTo)(body.returnTo) || (0, sanitizeReturnTo_1.sanitizeReturnTo)(refererPath);
