...
const goneJson = (context) => (0, response_helpers_1.createDeprecatedGoneJson)(context, 'This endpoint has been deprecated. Please use Magic Link login instead.', { Allow: 'POST' });
