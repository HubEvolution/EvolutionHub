...
const getHandler = async (context) => {
    ...
    if (!allowed.has(provider)) {
        return (0, response_helpers_1.createSecureRedirect)('/en/login?magic_error=InvalidProvider');
    }
    ...
    try {
        ...
        const authRes = await (0, stytch_1.stytchOAuthAuthenticate)(context, token);
