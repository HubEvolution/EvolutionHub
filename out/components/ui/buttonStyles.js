...
exports.BUTTON_VARIANTS = exports.BUTTON_SIZES = exports.BUTTON_BASE = void 0;
exports.BUTTON_BASE = [
...
exports.BUTTON_VARIANTS = {
    primary: 'text-white bg-gradient-to-br from-primary-500 via-primary-400 to-primary-300 hover:from-primary-400 hover:via-primary-300 hover:to-primary-200 active:brightness-95 focus:ring-primary-200/70 shadow-[0_12px_30px_-15px_rgba(6,182,212,0.8)] dark:from-primary-400 dark:via-primary-500 dark:to-primary-600 dark:hover:via-primary-400 dark:focus:ring-primary-500/60',
    ...
    ghost: 'text-primary-700 bg-gradient-to-br from-primary-500/15 via-primary-500/10 to-secondary-500/15 hover:from-primary-500/25 hover:via-primary-500/15 hover:to-secondary-500/25 active:bg-transparent focus:ring-primary-200/50 dark:text-primary-100 dark:from-primary-400/20 dark:via-primary-400/15 dark:to-secondary-500/20 dark:hover:from-primary-400/30 dark:hover:to-secondary-500/30 dark:focus:ring-primary-400/50',
    ...
    accent: 'text-white bg-gradient-to-br from-secondary-500 via-primary-500 to-primary-400 hover:brightness-[1.08] active:brightness-95 focus:ring-primary-200/70 shadow-[0_14px_35px_-18px_rgba(45,212,191,0.65)] dark:focus:ring-primary-400/70',
};
