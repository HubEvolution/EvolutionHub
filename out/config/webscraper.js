...
exports.EXTRACTION_LIMITS =
  exports.BLOCKED_DOMAINS =
  exports.ALLOWED_SCHEMES =
  exports.WEBSCRAPER_CONFIG =
    void 0;
...
exports.BLOCKED_DOMAINS = ['localhost', '127.0.0.1', '0.0.0.0', '::1', 'internal', 'local'];
...
function getWebscraperLimitFor(ownerType) {
  return ownerType === 'guest'
    ? exports.WEBSCRAPER_CONFIG.guestLimit
    : exports.WEBSCRAPER_CONFIG.userLimit;
}
