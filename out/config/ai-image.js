...
exports.DEFAULT_ASSISTANT_ID = exports.AI_R2_PREFIX = exports.ALLOWED_CONTENT_TYPES = exports.MAX_UPLOAD_BYTES = exports.PLAN_LIMITS = exports.FREE_LIMIT_USER = exports.FREE_LIMIT_GUEST = exports.ALLOWED_MODELS = void 0;
...
exports.ALLOWED_MODELS = [
    ...
    // Cloudflare Workers AI — Enhance (img2img)
    {
        ...
        supportsFaceEnhance: false,
        defaultParams: {
            prompt: 'photo restoration, high quality, detailed, natural, sharp focus, accurate colors, noise reduction',
            negative_prompt: 'cartoon, anime, text, watermark, oversharpen, artifacts, deformed, painting, unrealistic',
            strength: 0.25,
            guidance: 5,
            steps: 20,
        },
...
function getAiLimitFor(ownerType, plan) {
    if (ownerType === 'guest')
        return exports.FREE_LIMIT_GUEST;
    const p = plan ?? 'free';
