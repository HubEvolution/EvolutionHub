...
exports.ALLOWED_TYPES =
  exports.PDF_FILE_SEARCH_ENABLED =
  exports.TOP_P =
  exports.TEMPERATURE =
  exports.OUTPUT_TOKENS_MAX =
  exports.TEXT_LENGTH_MAX =
  exports.MAX_FILE_BYTES =
  exports.MAX_FILES =
  exports.DEFAULT_VISION_MODEL =
  exports.DEFAULT_TEXT_MODEL =
    void 0;
exports.DEFAULT_TEXT_MODEL = import.meta.env.PROMPT_TEXT_MODEL || 'gpt-4o-mini';
exports.DEFAULT_VISION_MODEL = import.meta.env.PROMPT_VISION_MODEL || 'gpt-4o-mini';
...
exports.ALLOWED_TYPES = import.meta.env.PROMPT_ALLOWED_TYPES?.split(',')
  .map((t) => t.trim())
  .filter(Boolean) || [
  'image/jpeg',
  'image/png',
