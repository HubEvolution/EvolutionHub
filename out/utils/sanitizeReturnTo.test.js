...
(0, vitest_1.describe)('sanitizeReturnTo', () => {
    (0, vitest_1.it)('allows valid path-only values', () => {
        ...
        (0, vitest_1.expect)((0, sanitizeReturnTo_1.sanitizeReturnTo)('/tools/imag-enhancer')).toBe('/tools/imag-enhancer');
        (0, vitest_1.expect)((0, sanitizeReturnTo_1.sanitizeReturnTo)('/en/pricing?plan=pro')).toBe('/en/pricing?plan=pro');
        (0, vitest_1.expect)((0, sanitizeReturnTo_1.sanitizeReturnTo)('/dashboard#billing')).toBe('/dashboard#billing');
    });
