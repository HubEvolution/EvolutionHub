...
exports.aiImageParamsSchema = zod_1.z
    ...
    face_enhance: zod_1.z.preprocess((val) => {
    ...
    prompt: zod_1.z.preprocess(emptyToUndefined, zod_1.z.union([zod_1.z.undefined(), zod_1.z.string().min(1).max(500)])),
    negative_prompt: zod_1.z.preprocess(emptyToUndefined, zod_1.z.union([zod_1.z.undefined(), zod_1.z.string().min(1).max(500)])),
    strength: zod_1.z.preprocess(emptyToUndefined, zod_1.z.union([zod_1.z.undefined(), zod_1.z.coerce.number().min(0).max(1)])),
    guidance: zod_1.z.preprocess(emptyToUndefined, zod_1.z.union([zod_1.z.undefined(), zod_1.z.coerce.number().min(1).max(12)])),
    steps: zod_1.z.preprocess(emptyToUndefined, zod_1.z.union([zod_1.z.undefined(), zod_1.z.coerce.number().int().min(1).max(60)])),
})
    .strict()
