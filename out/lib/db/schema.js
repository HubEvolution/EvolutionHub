...
const comments = (0, sqlite_core_1.sqliteTable)('comments', {
    ...
    authorId: (0, sqlite_core_1.text)('author_id').references(() => exports.users.id, { onDelete: 'cascade' }),
    ...
    entityType: (0, sqlite_core_1.text)('entity_type', { enum: ['blog_post', 'project', 'general'] }).notNull(),
    entityId: (0, sqlite_core_1.text)('entity_id').notNull(),
    status: (0, sqlite_core_1.text)('status', { enum: ['pending', 'approved', 'rejected', 'flagged', 'hidden'] })
        .notNull()
        .default('pending'),
...
exports.commentModeration = (0, sqlite_core_1.sqliteTable)('comment_moderation', {
    ...
    moderatorId: (0, sqlite_core_1.text)('moderator_id').references(() => exports.users.id, { onDelete: 'set null' }),
    action: (0, sqlite_core_1.text)('action', { enum: ['approve', 'reject', 'flag', 'hide', 'unhide'] }).notNull(),
...
exports.commentReports = (0, sqlite_core_1.sqliteTable)('comment_reports', {
    ...
    commentId: (0, sqlite_core_1.text)('comment_id')
        .notNull()
        .references(() => comments.id, { onDelete: 'cascade' }),
    reporterId: (0, sqlite_core_1.text)('reporter_id').references(() => exports.users.id, { onDelete: 'set null' }),
    reporterEmail: (0, sqlite_core_1.text)('reporter_email'),
    reason: (0, sqlite_core_1.text)('reason', {
        enum: ['spam', 'harassment', 'inappropriate', 'off_topic', 'other'],
    }).notNull(),
    description: (0, sqlite_core_1.text)('description'),
    status: (0, sqlite_core_1.text)('status', { enum: ['pending', 'reviewed', 'resolved', 'dismissed'] })
        .notNull()
        .default('pending'),
    createdAt: (0, sqlite_core_1.integer)('created_at', { mode: 'number' }).notNull(),
    reviewedAt: (0, sqlite_core_1.integer)('reviewed_at', { mode: 'number' }),
    reviewedBy: (0, sqlite_core_1.text)('reviewed_by').references(() => exports.users.id, { onDelete: 'set null' }),
});
...
exports.notifications = (0, sqlite_core_1.sqliteTable)('notifications', {
    ...
    priority: (0, sqlite_core_1.text)('priority', { enum: ['low', 'normal', 'high', 'urgent'] }).default('normal'),
...
exports.notificationSettings = (0, sqlite_core_1.sqliteTable)('notification_settings', {
    ...
    frequency: (0, sqlite_core_1.text)('frequency', { enum: ['immediate', 'daily', 'weekly', 'never'] }).default('immediate'),
    createdAt: (0, sqlite_core_1.integer)('created_at', { mode: 'number' }).notNull(),
    updatedAt: (0, sqlite_core_1.integer)('updated_at', { mode: 'number' }).notNull(),
...
exports.emailQueue = (0, sqlite_core_1.sqliteTable)('email_queue', {
    ...
    status: (0, sqlite_core_1.text)('status', { enum: ['pending', 'sending', 'sent', 'failed', 'cancelled'] }).default('pending'),
...
exports.dataExportJobs = (0, sqlite_core_1.sqliteTable)('data_export_jobs', {
    ...
    userId: (0, sqlite_core_1.text)('user_id')
        .notNull()
        .references(() => exports.users.id, { onDelete: 'cascade' }),
    type: (0, sqlite_core_1.text)('type', { enum: ['user_data', 'comments', 'notifications', 'full_export'] }).notNull(),
...
exports.dataDeletionRequests = (0, sqlite_core_1.sqliteTable)('data_deletion_requests', {
    ...
    processedBy: (0, sqlite_core_1.text)('processed_by').references(() => exports.users.id, { onDelete: 'set null' }),
    createdAt: (0, sqlite_core_1.integer)('created_at', { mode: 'timestamp' }).notNull(),
});
exports.backupJobs = (0, sqlite_core_1.sqliteTable)('backup_jobs', {
    id: (0, sqlite_core_1.text)('id').primaryKey(),
    type: (0, sqlite_core_1.text)('type', { enum: ['full', 'comments', 'users', 'incremental'] }).notNull(),
    status: (0, sqlite_core_1.text)('status', {
    ...
    completedAt: (0, sqlite_core_1.integer)('completed_at', { mode: 'timestamp' }),
    triggeredBy: (0, sqlite_core_1.text)('triggered_by').references(() => exports.users.id, { onDelete: 'set null' }),
...
exports.systemMaintenance = (0, sqlite_core_1.sqliteTable)('system_maintenance', {
    id: (0, sqlite_core_1.text)('id').primaryKey(),
    type: (0, sqlite_core_1.text)('type', { enum: ['cleanup', 'optimization', 'migration', 'repair'] }).notNull(),
    status: (0, sqlite_core_1.text)('status', {
        enum: ['pending', 'running', 'completed', 'failed', 'cancelled'],
    }).default('pending'),
