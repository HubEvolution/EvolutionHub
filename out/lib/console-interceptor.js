...
function installConsoleInterceptor() {
    ...
    console.error = (...args) => {
        ...
        client_logger_1.clientLogger.error(`[CONSOLE] ${stringifyArgs(...args)}`, { source: 'console' });
    };
    // Override console.debug
    console.debug = (...args) => {
        originalConsole.debug(...args);
        client_logger_1.clientLogger.debug(`[CONSOLE] ${stringifyArgs(...args)}`, { source: 'console' });
    };
