...
(0, vitest_1.describe)('locale-path helpers', () => {
    (0, vitest_1.describe)('localizePath', () => {
        (0, vitest_1.it)('prefixes english paths with /en', () => {
            (0, vitest_1.expect)((0, locale_path_1.localizePath)('en', '/blog/slug')).toBe('/en/blog/slug');
            (0, vitest_1.expect)((0, locale_path_1.localizePath)('en', 'blog/slug')).toBe('/en/blog/slug');
        ...
        (0, vitest_1.it)('does not double-prefix already localized paths', () => {
            (0, vitest_1.expect)((0, locale_path_1.localizePath)('en', '/en/blog/slug')).toBe('/en/blog/slug');
            (0, vitest_1.expect)((0, locale_path_1.localizePath)('de', '/en/blog/slug')).toBe('/en/blog/slug');
            (0, vitest_1.expect)((0, locale_path_1.localizePath)('de', '/de/blog/slug')).toBe('/de/blog/slug');
        });
        (0, vitest_1.it)('passes through external/hash/query links unchanged', () => {
            (0, vitest_1.expect)((0, locale_path_1.localizePath)('en', 'https://example.com/blog')).toBe('https://example.com/blog');
            (0, vitest_1.expect)((0, locale_path_1.localizePath)('en', 'mailto:test@example.com')).toBe('mailto:test@example.com');
    ...
    (0, vitest_1.describe)('switchLocalePath', () => {
        (0, vitest_1.it)('switches between locales preserving query/hash', () => {
            ...
            (0, vitest_1.expect)((0, locale_path_1.switchLocalePath)('en', 'https://site.local/blog?p=1#x')).toBe('/en/?p=1#x');
            (0, vitest_1.expect)((0, locale_path_1.switchLocalePath)('de', 'https://site.local/en/blog?p=1#x')).toBe('/blog?p=1#x');
        });
