...
// German locale variant of magic-link smoke
// On remote environments we only validate the request + cookie behavior, not the callback.

test.describe('Magic Link Flow (Stytch) – DE', () => {
  test('should request magic link and set post_auth_redirect cookie (DE)', async ({ page }) => {
