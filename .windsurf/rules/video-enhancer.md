...
- Kredite & Entitlements
  - Besitzer bestimmen (`user`/`guest`); Benutzer: Kreditstand (tenths) via `getCreditsBalanceTenths`, Fallback auf planbasierte Monatsquote (`getVideoEntitlementsFor`, `consumeVideoMonthlyQuotaTenths`).
