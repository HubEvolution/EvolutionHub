...
1. Mit der Edge-Computing-Architektur von Cloudflare kompatibel ist
1. Gute Performance bietet, auch bei hoher Last
1. Zustandslose Skalierung ermöglicht
1. Eine gute Benutzererfahrung bietet
...
1. **Token-Lebensdauer**: Access-Tokens mit kurzer Lebensdauer (1 Stunde)
1. **Passwort-Hashing**: Bcrypt mit angemessenem Work-Faktor (12)
1. **Rate-Limiting**: IP-basiertes Rate-Limiting für alle Authentifizierungsendpunkte
1. **CSRF-Schutz**: Durch SameSite=Strict Cookies und zusätzliche CSRF-Token für kritische Operationen
