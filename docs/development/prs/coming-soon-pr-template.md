---
description: 'PR-Template & Release-Checklist für Coming-Soon Overlay'
owner: 'Documentation Team'
priority: 'low'
lastSync: '2025-11-04'
codeRefs: 'src/components/ui/ComingSoon.astro, scripts/coming-soon-client.ts, src/config/coming-soon.ts, docs/frontend/coming-soon.md'
---
...
- E2E Tests (optional) unter [`tests/e2e/specs/coming-soon.spec.ts`](../../../tests/e2e/specs/coming-soon.spec.ts)
...
- Temporäres Coming-Soon Overlay für nicht-finalisierte Seiten, gesteuert ausschließlich per Frontmatter `comingSoon`. (Siehe [`docs/frontend/coming-soon.md`](../../frontend/coming-soon.md))
