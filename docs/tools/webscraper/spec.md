---
description: 'Webscraper Tool – Hauptspezifikation und Architektur'
owner: 'Tools Team'
priority: 'medium'
lastSync: '2025-11-04'
codeRefs: 'docs/tools/webscraper/spec.md, src/lib/services/webscraper-service.ts, src/pages/api/webscraper/**'
testRefs: 'N/A'
---
