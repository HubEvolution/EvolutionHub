...
1. W2 (Turnstile) — secrets only + small logging.
1. W3 (Origins) — env vars only.
1. W4 (Referrer-Policy) — small middleware change.
1. W1 (KV limiter) — code + KV namespaces; add tests.
1. W6–W9 documentation/flags/secrets verifications.
