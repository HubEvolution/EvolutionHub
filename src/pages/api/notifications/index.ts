...
const NOTIFICATION_PRIORITIES: readonly NotificationPriority[] = ['low', 'normal', 'high', 'urgent'];
...
function parseNotificationPriority(value: string | undefined | null): NotificationPriority | undefined {
  if (!value) return undefined;
