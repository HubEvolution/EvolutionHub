...
export const CommentStats: React.FC<CommentStatsProps> = ({ stats, className = '' }) => {
      ...
      <div className="flex items-center space-x-4 text-sm">
        ...
        {stats.approved > 0 && (
          <div className="flex items-center space-x-1">
            ...
            <span className="text-green-600 dark:text-green-400">{stats.approved} freigegeben</span>
          </div>
        )}
        ...
        {stats.pending > 0 && (
          <div className="flex items-center space-x-1">
            ...
            <span className="text-yellow-600 dark:text-yellow-400">{stats.pending} wartend</span>
          </div>
        )}
