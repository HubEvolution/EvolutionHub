  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-2 bg-gray-50 dark:bg-gray-900">
        {logs.length === 0 ? (
          <p className="text-gray-500 dark:text-gray-400 text-sm">Waiting for logs...</p>
        ) : (
          logs.slice().reverse().map((log, idx) => (
            ...
            >
              ...
              <span className={`px-2 py-0.5 rounded text-xs font-semibold mr-2 flex-shrink-0 ${getLevelColor(log.level)}`}>
