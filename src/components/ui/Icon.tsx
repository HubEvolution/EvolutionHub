...
export default function Icon({ name, className = 'w-6 h-6', ariaLabel }: IconProps) {
  ...
  switch (name) {
    case 'clipboard':
      return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden={ariaHidden} role={ariaLabel ? 'img' : undefined} aria-label={ariaLabel}>
    ...
    case 'tool':
      return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden={ariaHidden} role={ariaLabel ? 'img' : undefined} aria-label={ariaLabel}>
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M14 3l7 7-4 4-7-7" />
    ...
    case 'plug':
      return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden={ariaHidden} role={ariaLabel ? 'img' : undefined} aria-label={ariaLabel}>
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M7 7v4a4 4 0 004 4h2v2a1 1 0 001 1h2v-4l-4-4" />
    ...
    case 'statusDot':
      return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8 8" fill="currentColor" aria-hidden={ariaHidden} role={ariaLabel ? 'img' : undefined} aria-label={ariaLabel}>
    ...
    case 'lightbulb':
      return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden={ariaHidden} role={ariaLabel ? 'img' : undefined} aria-label={ariaLabel}>
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9 18h6M10 21h4" />
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9 13a4 4 0 116 0c0 1.657-1 2-1.5 3H10.5C10 15 9 14.657 9 13z" />
        </svg>
      );
    default:
      // Fallback generic circle
      return (
        <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden={ariaHidden} role={ariaLabel ? 'img' : undefined} aria-label={ariaLabel}>
