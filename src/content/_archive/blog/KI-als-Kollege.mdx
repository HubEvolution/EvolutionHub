...
<img src={figMuster.src} alt="Vier Kollaborationsmuster – Infografik" title="Die vier Grundmuster der KI-Kollaboration im Team" loading="lazy" />
...
<img src={figKpis.src} alt="KPI-Set – Mini-Dashboard" title="Die fünf Kennzahlen, die Wirkung sichtbar machen" loading="lazy" />

## 30-/60-/90-Tage-Plan

<img src={figPlan.src} alt="30/60/90-Tage-Plan – Roadmap" title="Vom Pilot zur Verankerung in drei Phasen" loading="lazy" />
