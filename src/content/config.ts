  ...
  schema: ({ image }) =>
    z
      .object({
        ...
        tags: z
          .array(z.string().min(2, 'Jedes Tag muss mindestens 2 Zeichen lang sein'))
        ...
        seo: z
          .object({
            title: z.string().max(60, 'SEO-Titel darf maximal 60 Zeichen lang sein').optional(),
            description: z
              .string()
              .max(160, 'SEO-Beschreibung darf maximal 160 Zeichen lang sein')
              .optional(),
            canonical: z.string().url('Muss eine gültige URL sein').optional(),
